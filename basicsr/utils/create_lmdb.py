...
def create_lmdb_for_reds():
    ...
    folder_path = '/data/wavelet/REDS/train/train_sharp'
    lmdb_path = '/data/wavelet/REDS/train/train_sharp.lmdb'
    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/data/wavelet/REDS/train/train_blur_jpeg'
    lmdb_path = '/data/wavelet/REDS/train/train_blur_jpeg.lmdb'
    img_path_list, keys = prepare_keys(folder_path, 'jpg')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)


def create_lmdb_for_gopro():
    #folder_path = '/data/wavelet/GoPro/train/blur_crops'
    #lmdb_path = '/data/wavelet/GoPro/train/blur_crops.lmdb'

    #img_path_list, keys = prepare_keys(folder_path, 'png')
    #make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    #folder_path = '/data/wavelet/GoPro/train/sharp_crops'
    #lmdb_path = '/data/wavelet/GoPro/train/sharp_crops.lmdb'
...
def create_lmdb_for_rain13k():
    folder_path = '/data/wavelet/Rain13k/train/input'
    lmdb_path = '/data/wavelet/Rain13k/train/input.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'jpg')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/data/wavelet/Rain13k/train/target'
    lmdb_path = '/data/wavelet/Rain13k/train/target.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'jpg')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

def create_lmdb_for_SIDD():
    folder_path = './data/SIDD/train/input_crops'
    lmdb_path = './data/SIDD/train/input_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'PNG')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './data/SIDD/train/gt_crops'
    lmdb_path = './data/SIDD/train/gt_crops.lmdb'
