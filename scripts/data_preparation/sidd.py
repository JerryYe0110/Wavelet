...
#DATA = '/data/wavelet/SIDD/Data'
#INPUT_CROPS = '/data/wavelet/SIDD/train/input_crops'
#GT_CROPS = '/data/wavelet/SIDD/train/gt_crops'

DATA = './data/SIDD/Data'
INPUT_CROPS = './data/SIDD/train/input_crops'
GT_CROPS = './data/SIDD/train/gt_crops'
...
def main():
    ...
    opt['input_folder'] = DATA
    opt['save_folder'] = INPUT_CROPS
    opt['crop_size'] = 512
    opt['step'] = 384
    opt['thresh_size'] = 0
    opt['keywords'] = '_NOISY'
